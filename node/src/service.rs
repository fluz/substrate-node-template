...
use substrate_governance_runtime::{self, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	substrate_governance_runtime::api::dispatch,
	substrate_governance_runtime::native_version,
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = sc_service::ServiceBuilder::new_full::<
			substrate_governance_runtime::opaque::Block, substrate_governance_runtime::RuntimeApi, crate::service::Executor
		>($config)?
