...
use poe_node_runtime::{self, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	poe_node_runtime::api::dispatch,
	poe_node_runtime::native_version,
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = sc_service::ServiceBuilder::new_full::<
			poe_node_runtime::opaque::Block,
			poe_node_runtime::RuntimeApi,
